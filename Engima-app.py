...
b_image=PhotoImage(file='images/background.png')
...
image_up =PhotoImage(file="images/up.gif")
image_down = PhotoImage(file='images/down.gif')

button = Button(frame7, image=image_up, bd=0, command=action)
button.place( relwidth=0.5, relheight=1)


button4=Label(frame7, text='Done', fg='black' ,bg='#c0c0c0', font=('Times', 12, 'bold'))
